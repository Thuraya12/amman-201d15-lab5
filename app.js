...
function multiplyArray(multArr) {
  ...
  let multiply2= multiply(multArr[0], multArr[1]);
  let multiplyb= multiply (multiply2[0], multArr[2]);

  return [multiplyb[0], `The numbers ${multArr} have a product of ${multiplyb[0]}.`]
  //eslint-disable-line
}
